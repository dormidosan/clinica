<div class="panel panel-default">
   <div class="panel-heading clearfix">
      <form id="fotos" name="fotos" class="fotos" method="post" action="{{ route('fotos.upload.post') }}" target="_blank">
         ...
         @if($foto3){{$foto3->tipo_foto->tipo_nombre}}@endif <button type="submit" class="btn btn-primary" style="float: right;">Subir</button>
      </form>
   </div>
   <div class="panel-body">
      @if($foto3)
      <img src="{{ asset('storage/fotos') }}/{{$foto3->url}}"
